...
// RabbitmqBindingStatus defines the observed state of RabbitmqBinding
type RabbitmqBindingStatus struct {
...
type RabbitmqBinding struct {
	...
	Status RabbitmqBindingStatus `json:"status,omitempty"`
}
