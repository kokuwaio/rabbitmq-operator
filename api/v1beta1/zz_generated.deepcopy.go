...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RabbitmqUserSetting) DeepCopyInto(out *RabbitmqUserSetting) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RabbitmqUserSetting.
func (in *RabbitmqUserSetting) DeepCopy() *RabbitmqUserSetting {
	if in == nil {
		return nil
	}
	out := new(RabbitmqUserSetting)
	in.DeepCopyInto(out)
	return out
}
