...
// RabbitmqPermissonReconciler reconciles a RabbitmqPermisson object
type RabbitmqPermissonReconciler struct {
	client.Client
	Log    logr.Logger
...
func (r *RabbitmqPermissonReconciler) Reconcile(req ctrl.Request) (ctrl.Result, error) {
...
func (r *RabbitmqPermissonReconciler) SetupWithManager(mgr ctrl.Manager) error {
